...
module.exports = function (adapter, schemas) {
    ...
    function appendLinkedResources(body, primaryResourceName, inclusions, sparseFields) {
        ...
        return fetchLinked({}, resources, inclusionTree, sparseFields)
    ...
    function fetchLinked(fetchedIds, resources, inclusionBranch, sparseFields) {
        return Promise
            .all(_.map(_.keys(inclusionBranch ? inclusionBranch.refs : []), function (inclusionRefKey) {
                return fetchResources(fetchedIds, resources, inclusionBranch, inclusionRefKey, sparseFields)
                    .then(function (result) {
                        if (result && result.data) {
                            return fetchLinked(fetchedIds, result.data, inclusionBranch.refs[inclusionRefKey], sparseFields).then(function (subResult) {
    ...
    function fetchResources(fetchedIds, resources, inclusionBranch, inclusionRefKey, sparseFields) {
